...
function Movie() {
    ...
    return (
        <div className={`movie-${movieId} space-y-7`}>
            {/* Landing */}
            <div
            ...
            <div className='container py-5 space-y-7'>
                ...
                <div className='content-grid grid grid-cols-1 md:grid-cols-3 gap-5 items-start'>
                    ...
                    <div className='details md:col-span-2 space-y-5'>
                        ...
                        {/* Images */}
                        <MediaImages mediaType={`movie`} mediaId={movieId} />
                        {/* Reviews */}
                        <MediaReviews mediaType={`movie`} mediaId={movieId} />
                    </div>
                    {/* Sub Info */}
                    <MediaSubInfoCard mediaData={mediaQuery.data} />
                </div>
                {/* Media Recommendations */}
                <MediaRecommendations mediaId={movieId} mediaType={`movie`} />
            </div>
        </div>
    )
}
